...
class AnimalAdocao extends Animal{
    ...
    public function getIdAnimal($nome){
        ...
        try{
            ...
            $result = $conn->query("SELECT animais_adocao.id FROM animais_adocao WHERE animais_adocao.nome = '".$nome."';")->fetchAll(PDO::FETCH_ASSOC);
	...
	public function getAllByUserId($id){
        ...
        try{
            ...
            $result = $conn->query("SELECT DISTINCT animais_adocao.* FROM animais_adocao INNER JOIN usuario ON animais_adocao.usuario_id WHERE animais_adocao.usuario_id = ".$id.";")->fetchAll(PDO::FETCH_ASSOC);
	...
	public function setSituacaoAdotado($id){
        ...
        try{
            ...
            $result = $conn->prepare("UPDATE animais_adocao SET situacao = 1 WHERE id = ".$id.";");
	...
	public function setSituacaoRemovido($id){
        ...
        try{
            ...
            $result = $conn->prepare("UPDATE animais_adocao SET situacao = 3 WHERE id = ".$id.";");
    ...
    public function resetSituacaoNaLista($id){
        ...
        try{
            ...
            $result = $conn->prepare("UPDATE animais_adocao SET situacao = 0 WHERE id = ".$id.";");
    ...
    public function addImagem($imagem,$id,$animalId){
        ...
        try{
            ...
            if (isset($_FILES['foto-animal'])){
                ...
                $diretorio = "views/_images/user/animal/adocao/";//define o diretório para o arquivo vai ser enviado

                move_uploaded_file($_FILES['foto-animal']['tmp_name'], $diretorio.$novo_nome);// efetua o upload 

                $sql = "UPDATE animais_adocao SET foto ='".$novo_nome."' WHERE id =".$id."; ";
...
public function registraAnimal($usuario_id,$imagem){
        ...
        try {
            ...
            if($this->checarNome($this->getNome())!= true){
                ...
                $sql = "INSERT INTO animais_adocao(nome,raca,idade,tipo,porte,descricao,usuario_id) values ('".$this->getNome()."','".$this->getRaca()."',".$this->getIdade().",'".$this->getTipo()."','".$this->getPorte()."','".$this->getDescricao()."',".$usuario_id.");";
                $conn->prepare($sql);
                $conn->exec($sql);
            ...
            if (isset($_FILES['foto-animal'])){
                ...
                $sql = "UPDATE animais_adocao SET foto ='".$novo_nome."' WHERE id =".$id[0]['id']."; ";
    ...
    public function checarNome($nome){
        ...
        try {
            ...
            $result = $conn->query("SELECT * FROM animais_adocao where nome = '".$nome."';")->fetchAll();
    ...
    //TODO Fazer com que o sql do addImagem() receba um parâmetro de id do usuário E o id do animal...
