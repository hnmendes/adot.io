...
$valorporte = explode("=",$url[1]);

$valoridade = explode("=",$url[0]);

$valorporte = $valorporte[1];
...
// $animal = $animal->searchByPorteIdade($valorporte,$valoridade);
        ...
        <div class="col s12 ">
            <div class="card ">
                ...
                <?php
                    ...
                    $animais = $animais->searchByPorteIdade($valorporte,$valoridade);
                ...
                */
                ...
                if(count($animais) != 0 && sizeof($animais)){
                ...
                // var_dump($animal['foto']);
                    if($animal['foto'] == null || $animal['foto'] == ""){
                        ...
                        echo '<img src="views/_images/user/animal/perdido/'.$animal['foto'].'" width="200" class="responsive-img" id="doog">';
                    }
                ...
                echo '  
                    ...
                    echo '<div class="row adocao-animais"><div class="card"><div class="card-content"><p>Não houve resultados para sua pesquisa.</p></div></div></div>';
                }
