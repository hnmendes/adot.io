			...
			*/
            ...
            // var_dump($animal['foto']);
				if($animal['foto'] == null || $animal['foto'] == ""){
					...
					echo '<img src="views/_images/user/animal/adocao/'.$animal['foto'].'" width="100" height="100" class="responsive-img" id="doog">
				...
				<br>    <h5><b>Idade:</b> 
							...
							<br>  <br> </div> 
								<div class="card-action">
							<button href="#modal'.$i.'" class="waves-effect waves-light btn modal-trigger">
							<i class="material-icons left">pets</i>Informações</button>
								</div>
							</div>
							<!-- Modal Structure -->
                    ...
                    // var_dump($i);
							...
							if($animal['situacao'] == 0){
								...
								/* DIV AQUI*/	echo '<div class="divider"></div>';
                ...
                if((isset($_SESSION['logado']))&&($_SESSION['id'] == $animal['usuario_id']) && ($animal['situacao'] != 3)){ //todo
                	...
                	<button type="submit" class="waves-effect waves-light btn"><i class="material-icons left">pets</i>Remover da lista</button></form>
...
$animais = $animais->getAll();
			...
			| usuario_id | int(11)      | NO   | MUL | NULL    |       |
			+------------+--------------+------+-----+---------+-------+
			Qual é a página que tá dando mesmo ?
			*/
			$i = 0;
			foreach($animais as $animal){
            ...
            // var_dump($animal['foto']);
				if($animal['foto'] == null || $animal['foto'] == ""){
					...
					echo '<img src="views/_images/user/animal/adocao/'.$animal['foto'].'" width="150px" class="responsive-img" id="doog">
						</div>';
						/* FECHAMENTO DO CARD-IMAGE*/
				}
							/* aberturas do stacked e content*/
